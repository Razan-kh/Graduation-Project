...
//   final List<_TechStackData> techStackData = [
//     _TechStackData('React', 30, 'assets/icons/react.png'),
//     _TechStackData('Node.js', 25, 'assets/icons/node.png'),
//     _TechStackData('MongoDB', 20, 'assets/icons/mongo.png'),
//     _TechStackData('Docker', 15, 'assets/icons/docker.png'),
//     _TechStackData('Flutter', 10, 'assets/icons/flutter.png'),
//   ];
...
//                 PieSeries<_TechStackData, String>(
//                   dataSource: techStackData,
//                   xValueMapper: (data, _) => data.name,
//                   yValueMapper: (data, _) => data.percentage,
//                   dataLabelMapper: (data, _) => '${data.percentage}%',
...
//             spacing: 10,
//             runSpacing: 10,
//             children: techStackData.map((tech) {
//               return Chip(
//                 avatar: Image.asset(tech.iconPath, width: 24, height: 24),
...
// class _TechStackData {
//   final String name;
//   final double percentage;
//   final String iconPath;

//   _TechStackData(this.name, this.percentage, this.iconPath);
// }
